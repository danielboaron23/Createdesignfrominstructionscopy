...
function Frame() {
  return (
    <div className="content-stretch flex flex-col items-end leading-[32px] not-italic relative shrink-0 text-[#2d2d2d] text-center w-full">
      <p className="font-['Open_Sans_Hebrew:Bold',sans-serif] overflow-hidden relative shrink-0 text-[24px] text-ellipsis w-full" dir="auto">
        איזה שיר?
      </p>
      <p className="font-['Open_Sans_Hebrew:Regular',sans-serif] min-h-[56px] overflow-hidden relative shrink-0 text-[21px] text-ellipsis w-full" dir="auto">
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col items-end leading-[32px] not-italic relative shrink-0 text-[#2d2d2d] text-center w-full">
      <p className="font-['Open_Sans_Hebrew:Bold',sans-serif] overflow-hidden relative shrink-0 text-[24px] text-ellipsis w-full" dir="auto">{`20 שאלות `}</p>
      <p className="font-['Open_Sans_Hebrew:Regular',sans-serif] min-h-[56px] overflow-hidden relative shrink-0 text-[21px] text-ellipsis w-full" dir="auto">
...
function Component1() {
  return (
    <div className="content-stretch flex gap-[20px] h-[56px] items-start justify-end relative shrink-0" data-name="02">
      <div className="bg-white relative rounded-[12px] self-stretch shrink-0 w-[352px]" data-name="Section / Games">
        <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[16px] items-center px-[40px] py-[28px] relative size-full">
            <div className="relative shrink-0 size-[88px]">
...
function Component2() {
  return (
    <div className="content-stretch flex gap-[12px] h-[56px] items-start justify-end relative shrink-0 w-full" data-name="03">
      <div className="bg-white relative rounded-[12px] self-stretch shrink-0 w-[352px]" data-name="Section / Games">
        <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[16px] items-center px-[40px] py-[28px] relative size-full">
            <div className="relative shrink-0 size-[88px]">
...
export default function MainListXxl() {
  return (
    <div className="content-stretch flex flex-col gap-[28px] items-end relative size-full" data-name="Main List XXL">
      <div className="content-stretch flex h-[72px] items-start justify-end relative shrink-0" data-name="Horizontal Title-Section Page">
        <Frame10 />
      </div>
      <GameMain />
    </div>
